[![CI/CD](https://github.com/dmorn/edrawings-scan-open-loop/actions/workflows/ci.yaml/badge.svg)](https://github.com/dmorn/edrawings-scan-open-loop/actions/workflows/ci.yaml)
